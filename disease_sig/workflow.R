...
#validate disease signatures using the optimal thershold
source("../code/disease_sig/valid")

#validate reduced disease signatures using the optimal thershold
...
#validate reduced disease signatures TCGA
