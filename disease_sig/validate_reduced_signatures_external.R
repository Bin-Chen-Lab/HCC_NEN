#create ROC curves for external datasets using reduced disease signatures 
...
save(rocs, file = paste( cancer, "/dz_sig/reduced_rocs.RData", sep=""))

#load( paste( cancer, "/", cancer,"/sig/reduced_rocs.RData", sep=""))
pdf(paste(  cancer,"/dz_sig/reduced_rocs.pdf", sep=""))
